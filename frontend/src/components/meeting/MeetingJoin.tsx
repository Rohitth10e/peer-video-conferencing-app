...
export function MeetingJoin({videoRef, mic, vid, setMic, setVid}) {
    ...
    return (
        <div className="w-full h-screen flex flex-col">
            {/* Navbar */}
            <div className="w-full bg-white flex justify-between items-center border-b border-zinc-200 py-2 px-36 shadow-sm">
            ...
            {/* Main Layout */}
            <div className="main-layout w-full bg-blue-50 min-h-screen py-10 px-36 flex justify-between">
                <div className='left-container'>
                    <div className='flex items-center gap-8'>
                        <p
                            className={meetingSelection==="create"? 'text-blue-500': '' }
                            onClick={()=>setMeetingSelection("create")}
                        >
                            Create
                        </p>
                        <p
                            className={meetingSelection==="join"? 'text-blue-500': '' }
                    ...
                    </div>
                    {
                        meetingSelection === "create" ?
                            <div className={"flex flex-col items-start w-[350px] rounded-md bg-white p-4 h-auto mt-8 gap-8"}>
                                ...
                                <div className='card-foot'>
                                    <button className='px-2 w-[320px] py-1 bg-blue-500 text-white rounded-sm font-semibold'
                            ...
                            <div className={"flex flex-col items-start w-[350px] rounded-md bg-white p-4 h-auto mt-8 gap-8"}>
                                ...
                                <div className='card-foot'>
                                    <button className='px-2 py-1 w-[320px] bg-blue-500 text-white rounded-sm font-semibold'>
                                        Join
                                    </button>
                                    <p className='text-xs text-zinc-500 tracking-tighter mt-2'>Room IDs are 10 characters long (letters and numbers)</p>
                                </div>
                            </div>
                    }
                </div>
                <div className='right-container'>
                    ...
                    autoPlay
                    playsInline
                    className="rounded-xl border-[2px] border-blue-400 max-h-80"
                    />
